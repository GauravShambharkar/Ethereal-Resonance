...
export const OctaveControl = () => {
  ...
  const displayOctave = isMounted ? baseOctave : 2;
      ...
      <div className="flex items-center gap-1.5 ">
        {[1, 2, 3, 4].map((oct) => (
          <button
            ...
            className={`w-6 h-6 rounded-full flex items-center justify-center text-[11px] font-bold font-headline transition-all duration-300 active:scale-75 ${displayOctave === oct
